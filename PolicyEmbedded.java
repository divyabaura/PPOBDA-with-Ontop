...
public class PolicyEmbedded {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String ontologyFilePath = "dummy2.owl";
        String mappingFilePath = "dummy2_original.obda";
        String metadataFilePath = "dummy2_original.json";

        // Specify the path to the SPARQL queries JSON file
        String sparqlJsonFilePath = "predicatetosparql.json";
        //load the ontology
        OWLOntologyManager ontologyManager = OWLManager.createOWLOntologyManager();
        OWLOntology ontology; // Define the ontology variable

        try (InputStream in = Files.newInputStream(Paths.get("dummy2.owl"))) {
            assert in != null;
        ...
        Map<OntologyPredicateAtom, OntopReformulationResult> predicatetoSQLQuery = generateSQL(ontologyFilePath, mappingFilePath, metadataFilePath, viewsByAtom);//ToDO: replace string with OntopReformulationResult
