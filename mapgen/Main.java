...
public class Main {
    public static void main(String[] args) throws OWLOntologyCreationException, IOException {
        ...
        String owlFilePath = scanner.nextLine();
        ...
        System.out.println("Ontology loaded successfully from: " + owlFilePath);
